...
stargazer( data = cars,              
           type = "text",            
           keep = c( "mpg", "hp" ),       # specified variables using *keep*
...
# Part 3: Raw data
You can use `stargazer` to create pretty tables from most rectangular sources of raw data, such as dataframes and matrixes.
...
If you want to get some hands-on coding practice using `stargazer`, try working through my coding challenge, which I preview below.

```{r coding_challenge_preview}

# I will make this code chunk available the day of the live workshop

# Part 1: Table of raw data
# Part 2: Summary statistics table
# Part 3: Modeling output table
